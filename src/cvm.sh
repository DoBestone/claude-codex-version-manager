...
_cvm_completions() {
  local commands="codex use install uninstall remove rm pin unpin default list ls current installed remote releases self-update update clean doctor changelog version help"
